//
//  badMessageViewController.swift
//  Safehouse
//
...
class badMessageViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        messageLabel.text = "Message  \(event.msg)"
        reverseGeocoding(lat: event.location.latitude, long: event.location.longitude , completionHandler: { (pm) in
            ...
            self.placeLabel.text = addressString
        })
    ...
    override func viewDidLayoutSubviews() {
        self.messageReadButton.layer.cornerRadius = self.messageReadButton.frame.height / 2
    }

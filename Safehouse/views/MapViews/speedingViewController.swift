...
class speedingViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        speedLabel.text = "\(event.speed) mph in \(event.speed_limit) mph zone"
